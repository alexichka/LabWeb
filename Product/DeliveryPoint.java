...
public class DeliveryPoint implements Remote, DeliveryPointInterface, Serializable {
    ...
    //------------------------чтение и запись-------------------------------
    public static void writeProducts(@NotNull Writer out, DeliveryPoint deliveryPoint, char delimiter) throws IOException {
    ...
    public static DeliveryPoint readProducts(@NotNull Reader in, char delimiter) throws IOException, ParseException {
